...
def update_output(runner_id, benchmark_pos_id, benchmark_neg_id, explore):
    ...
    return html.Div(children=[
        pygwalker(pd.concat([df_pos, df_neg]), spec=res_spec, gw_mode=mode),
        pygwalker(df_roc, spec=f1_spec, gw_mode=mode),
    ])
